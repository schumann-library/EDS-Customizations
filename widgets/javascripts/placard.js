...
(function() {
    ...
    function StartSpringsharePlacard() {
        ...
        var placard = '<div id="Placard_springy" style="border-width:' + springshareParams[9] +';"><div></div><span id="Placard_libguides"></span><span id="Placard_libanswers"></span><span id="Placard_libdatabases"></span></div>';
